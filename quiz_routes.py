...
def _extract_pdf_text(pdf_file, max_pages=15, max_chars=4500):
...
6. Return exactly {b_count} questions."""
        ...
        try:
            raw = _groq_call(system_prompt, user_prompt, max_tokens=min(3000, 250 + b_count * 280), temperature=0.5)
...
Vary question types. All options specific and plausible."""
        ...
        try:
            raw = _groq_call(system_prompt, user_prompt, max_tokens=min(3000, 250 + b_count * 280), temperature=0.4)
